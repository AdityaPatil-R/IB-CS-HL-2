...
public class QuestionGame {
    ...
    private static void playGame(QuestionNode tree) {
        ...
        if (guessNumber > 20) {
            System.out.print(
                    "I've exceeded my 20 alloted guesses, and have lost! That was fun! Do you want to play with me again?     ");
        ...
        if (tree.yes == null && tree.no == null) {
            ...
            if (answer.equals("yes")) {
                ...
                System.out.print("Write a yes-or-no question that would clearly distinguish " + tree.object + " from "
                        + correctAnswer + ":     ");
                String newQuestion = scanner.nextLine();

                System.out.print("If the object was " + correctAnswer + ", what would the answer to \"" + newQuestion
                        + "\" be?     ");
